...
declare global {
    ...
    type MetaType = {
        ...
        "viz:freqLow"?: number;
        "viz:freqHigh"?: number;
        "viz:crossover"?: number;
        "viz:splitMode"?: boolean;
        "viz:colorLowDim"?: string;
        "viz:colorLowBright"?: string;
        "viz:colorHighDim"?: string;
        "viz:colorHighBright"?: string;
        "viz:attack"?: number;
        "viz:release"?: number;
        "viz:lowAttack"?: number;
        "viz:lowRelease"?: number;
        "viz:highAttack"?: number;
        "viz:highRelease"?: number;
        "bg:*"?: boolean;
        bg?: string;
        "bg:opacity"?: number;
        "bg:blendmode"?: string;
